...
Execution is handled by [Invoke-MalDoc](https://rangegogs.cnd.ca.gov/Range/invoke-atomicredteam/blob/master/Public/Invoke-MalDoc.ps1) to load and execute VBA code into Excel or Word documents.
