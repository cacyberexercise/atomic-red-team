...
| portfile_url | URL to top-128.txt | url | https://rangegogs.cnd.ca.gov/Range/atomic-red-team/raw/master/atomics/T1016/src/top-128.txt|
...
Invoke-WebRequest "https://rangegogs.cnd.ca.gov/Range/atomic-red-team/raw/master/atomics/T1016/src/qakbot.bat" -OutFile "#{recon_commands}"
```
