...
| Name | Description | Type | Default Value |
|------|-------------|------|---------------|
| input_url | Url to download the DLL | url | https://rangegogs.cnd.ca.gov/Range/atomic-red-team/raw/master/atomics/T1047/bin/calc.dll|
...
| Name | Description | Type | Default Value |
|------|-------------|------|---------------|
| input_url | Url to download the DLL | url | https://rangegogs.cnd.ca.gov/Range/atomic-red-team/blob/master/atomics/T1218.010/bin/AllTheThingsx64.dll|
...
| dll_url | The URL to the DLL file that must be downloaded | url | https://rangegogs.cnd.ca.gov/Range/atomic-red-team/raw/master/atomics/T1218.011/bin/_WT.init|
