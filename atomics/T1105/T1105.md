...
| Name | Description | Type | Default Value |
|------|-------------|------|---------------|
| file_download | File to download | string | https://rangegogs.cnd.ca.gov/Range/atomic-red-team/raw/058b5c2423c4a6e9e226f4e5ffa1a6fd9bb1a90e/atomics/T1218.010/bin/AllTheThingsx64.dll|
...
Invoke-WebRequest "https://rangegogs.cnd.ca.gov/Range/atomic-red-team/raw/master/atomics/T1105/src/T1105.bat" -OutFile "#{Path_to_file}"
```
...
Invoke-WebRequest "https://rangegogs.cnd.ca.gov/Range/atomic-red-team/raw/master/atomics/T1105/src/redcanary.cab" -OutFile "#{replace_cab}"
```
...
Invoke-WebRequest "https://rangegogs.cnd.ca.gov/Range/atomic-red-team/raw/master/atomics/T1105/src/T1105-download-file.vbs" -OutFile "#{vbscript_file}"
```
...
| Name | Description | Type | Default Value |
|------|-------------|------|---------------|
| remote_url | URL of the C2 Server from where file/s need to be downloaded | url | https://rangegogs.cnd.ca.gov/Range/atomic-red-team/raw/master/atomics/T1105/src/T1105.zip|
